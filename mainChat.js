...
function appendCustPreChatSnapinDom(snapInObject, preChatlableObject) {
    ...
    if (!document.getElementById('cusPreChatSnapinDom')) {
        ...
        if (snapInObject.isEmcProduct && snapInObject.siteId && (snapInObject.epdmId==''|| snapInObject.epdmId==null ))
	{
...
function prePopulateCustPreFormValues(snapInObject) {
    ...
    if ("alternateEmailAddress" in snapInObject)
        document.getElementById("cusPreChat-prefillAltEmail").value = snapInObject.alternateEmailAddress;
}
...
function initOriginalESW(gslbBaseURL, snapInObject) {
    ...
    if (snapInObject.isEmcProduct) {
        ...
        embedded_svc.settings.extraPrechatFormDetails = [
            ...
            { "label": "Asset", "value": "", "transcriptFields": ["Service_Tag__c"] },//1.FY21-0502:[Sprinklr Chat Bot]: Adding new Field to be pushed to transcript 2.Story FY21-1003-:[STORY 9161239]:Adding new fields.
